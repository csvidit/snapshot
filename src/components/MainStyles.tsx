...
export const landingPageContainerStyles = "w-screen h-screen flex flex-col space-y-6 justify-center bg-slate-200 dark:bg-slate-900";

export const mainContainerStyles =
  "w-screen h-fit flex flex-col space-y-6 justify-center bg-slate-200 dark:bg-slate-900";
